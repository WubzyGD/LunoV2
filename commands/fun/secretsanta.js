    ...
    async execute(message, msg, args, cmd, prefix, mention, client) {
        ...
        if (['create', 'new', 'c', 'n', 's'].includes(args[0].toLowerCase())) {
            ...
            return dmch.send({embeds: [new Discord.MessageEmbed()
                ...
                .setDescription("Your Secret Santa has been completed! Have your members join by using `l.secretsanta join <ID>` where the ID is the ID displayed below. You can start your secret santa when you have at least 3 members with `l.secretsanta start <ID>`. If someone joins that you don't want in your secret santa, use `l.secretsanta kick <ID> <@member|userID>`. If you want to also participate, just join the same way as everyone else.")
